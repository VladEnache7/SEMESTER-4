...
namespace Lab2V3
{
    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("12.12.2020// - " + DataValidator.IsValidDate("12.12.2020//"));
            Console.WriteLine("2002.1.2 - " + DataValidator.IsValidDate("2002.1.2"));

            // testing the SanitizeInput method
            Console.WriteLine("\n<---Testing the SanitizeInput method--->");
            Console.WriteLine("SELECT * FROM users - " + DataValidator.SanitizeInput("SELECT * FROM users"));
            Console.WriteLine("1 or 1 = 1 - " + DataValidator.SanitizeInput("1 or 1 = 1"));
            Console.WriteLine("1 ; DROP TABLE users  - " + DataValidator.SanitizeInput("1 ; DROP TABLE users "));
